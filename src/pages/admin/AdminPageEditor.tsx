...
const PAGE_CONTENT_SCHEMA: Record<string, FieldDef[]> = {
  accueil: [
    ...
    { type: 'section', label: "Actualité blog — utilisez le bloc « Article mis en avant » ci-dessous" },
  ...
  'mentions-legales': [
    { type: 'text',     key: 'hero_title',           label: 'Titre de la page' },
    { type: 'section',  label: 'Éditeur du site' },
    { type: 'text',     key: 'editeur_title',        label: 'Titre de section' },
    { type: 'textarea', key: 'editeur_content',      label: 'Contenu' },
    { type: 'section',  label: 'Hébergement' },
    { type: 'text',     key: 'hebergement_title',    label: 'Titre de section' },
    { type: 'textarea', key: 'hebergement_content',  label: 'Contenu' },
    { type: 'section',  label: 'Données personnelles' },
    { type: 'text',     key: 'donnees_title',        label: 'Titre de section' },
    { type: 'textarea', key: 'donnees_content',      label: 'Contenu' },
    { type: 'section',  label: 'Cookies' },
    { type: 'text',     key: 'cookies_title',        label: 'Titre de section' },
    { type: 'textarea', key: 'cookies_content',      label: 'Contenu' },
  ],
  blog: [
    { type: 'text', key: 'hero_title',    label: 'Titre principal' },
    { type: 'text', key: 'hero_subtitle', label: 'Sous-titre' },
